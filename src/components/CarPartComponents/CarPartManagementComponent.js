...
function DeleteCarPartComponet({user , setuser}) {
  ...
  const fetchCarParts = async () => {
    try {
        const response = await axios.get('https://backenddeploymen.onrender.com/car-parts/view-parts', {
            headers: {
  ...
  const handleDelete = async (carId) => {
    try {
    await axios.delete(`https://backenddeploymen.onrender.com/car-parts/delete-part/${carId}`, {
        headers: {
          'token': JSON.parse(localStorage.getItem('token')),
        },
    });
  ...
  const handleSearch = async () => {
    ...
    const response = await axios.post("https://backenddeploymen.onrender.com/car-parts/search-part", obj, {
        headers: {
          'token': JSON.parse(localStorage.getItem('token')),
        },
    });
